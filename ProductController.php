...
class ProductController extends Controller
{
    const PRODUCTS = [
        ...
        'name' => 'JavaScript: The Definitive Guide','description' => <<<EOT
...
EOT
    ...
    you’ll tackle dynamic web programming with the latest versions of today’s core technologies:
PHP
MySQL
JavaScript
CSS
...
EOT
        ...
        function view(string $productCode): View 
        {
            ...
            'categories' => CategoryController::CATEGORIES[self::PRODUCTS[$productCode]['catCode']],
            ]);
        }
